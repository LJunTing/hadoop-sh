 ...
 * 指定 offset
 */
public class CustomerConumerSimple {


    public static void main(String[] args) {
        //定义相关参数
        ArrayList<String> borkers = new ArrayList<String>();
        borkers.add("mini1");
        borkers.add("mini2");
        borkers.add("mini3");
        ...
        findLeader(borkers, port, topic, partition);
    }


    public static String findLeader(ArrayList<String> borkers, int port, String topic, int partition) {
        Properties props = new Properties();
        props.put("bootstrap.servers", "mini1:9092,mini2:9092,mini3:9092");
        // group.id，指定了消费者所属群组
        props.put("group.id", "CountryCounter");
        //  props.put("offset.reset", "earliest"); //读取 offset
        // 是否自动确认offset
        ...
        consumer.subscribe(Collections.singletonList("first2"));
        while (true) {
